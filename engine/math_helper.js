...
function intersection_square(square, point) {
	...
	if ((intersection_1 > 0 && intersection_2 > 0 && intersection_3 > 0 && intersection_4 > 0) || (intersection_1 > 0 && intersection_2 > 0 && intersection_3 > 0 && intersection_4 > 0)) return true;
